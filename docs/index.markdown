...
Welcome to the **The AI Alliance**: **Conversational BI**. 
...
{: .note }
> **NOTE:** This is a work-in-progress website for the Conversational BI.
...
* [Project GitHub Repo](https://github.com/The-AI-Alliance/conversational_bi){:target="repo"}
